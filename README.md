...
This repository contains the hardware design files for a custom, Altium Designer-based STM32F411 development board. The project encompasses the complete PCB design lifecycle, including schematic capture, component selection, routing, and manufacturing data generation.
...
### Schematic
![Schematic 1](images/Screenshot%20(811).png)
![Schematic 2](images/Screenshot%20(812).png)
![Schematic 3](images/Screenshot%20(816).png)
![Schematic 4](images/Screenshot%20(817).png)

### PCB Layout (2D)
![PCB 2D View](images/Screenshot%20(818).png)

### 3D Render
![3D View](images/Screenshot%20(819).png)
